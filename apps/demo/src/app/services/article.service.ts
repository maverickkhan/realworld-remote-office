...
export async function getArticles(
  ...
  return fetch('http://localhost:3003/api/articles?' + params, {
    headers: getHeaders(),
    signal,
  }).then(res => res.json());
}
...
export async function getPersonalFeed(
  ...
  return fetch('http://localhost:3003/api/articles/feed?' + params, {
    headers: getHeaders(),
    signal,
  }).then(res => res.json());
}
...
export async function getArticle(slug: string): Promise<Article> {
  return fetch(`http://localhost:3003/api/articles/${slug}`, {
    headers: getHeaders(),
  })
    .then(res => res.json())
...
export async function createArticle(article: unknown): Promise<Response> {
  return fetch('http://localhost:3003/api/articles', {
    method: 'POST',
    headers: getHeaders(),
...
export async function favoriteArticle(slug: string): Promise<Article> {
  return fetch(`http://localhost:3003/api/articles/${slug}/favorite`, {
    method: 'POST',
    headers: getHeaders(),
  })
    .then(res => res.json())
...
export async function likeArticle(slug: string): Promise<Article> {
  return fetch(`http://localhost:3003/api/articles/${slug}/like`, {
    method: 'POST',
    headers: getHeaders(),
  })
    .then(res => res.json())
...
export async function unlikeArticle(slug: string): Promise<Article> {
  return fetch(`http://localhost:3003/api/articles/${slug}/like`, {
    method: 'DELETE',
    headers: getHeaders(),
  })
...
export async function dislikeArticle(slug: string): Promise<Article> {
  return fetch(`http://localhost:3003/api/articles/${slug}/dislike`, {
    method: 'POST',
    headers: getHeaders(),
  })
    .then(res => res.json())
